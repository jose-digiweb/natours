...
exports.login = catchAsync(async (req, res, next) => {
  ...
  if (!user || !(await user.correctPassword(password, user.password))) {
    return next(new AppError('The provided details are not correct', 401));
  }
...
exports.protect = catchAsync(async (req, res, next) => {
  // GETTING THE TOKEN AND CHECK IF IT'S THERE ARE
  let token;
  ...
  // IF IT WAS ALL OK BY NOW... THEN CALL THE NEXT
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // IF TOKEN IS NOT EXPIRED, AND IF THERE IS A USER THEN SET THE NEW PASSWORD
  if (!user) {
